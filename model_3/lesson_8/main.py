...
from model_3.lesson_8.weather import WeatherManager
from model_3.lesson_8.keyboards import days_btn
from model_3.lesson_8.student import Student
from model_3.lesson_8.utils import write_to_csv, is_exist_chat_id

BOT_TOKEN = "6031569530:AAE8Abn0Ar-DO5XWX5H4Yd4ZuZJ7sZqdFAQ"
...
def welcome_message(message):
    ...
    if not is_exist_chat_id(chat_id):
        student = Student(fullname, chat_id)
